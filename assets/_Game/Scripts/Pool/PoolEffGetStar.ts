...
@ccclass('PoolEffGetStar')
export class PoolEffGetStar extends Component {
    @property( Prefab )
    public effPrefabs: Prefab = null;
    @property( Node )
    ...
    public initializePool ( size: number ): void
    {
        ...
        {
            const node = instantiate( this.effPrefabs );
    ...
    public getFromPool (): Node
    {
        ...
        {
            node = instantiate( this.effPrefabs );
            return node;
        }
    }
